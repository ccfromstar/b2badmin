...
function _setFiled(obj){
  var result = "";
  result = result + "<thead>"+_setHeader("餐厅名|名称|图片")+"</thead><tbody>";
  for(var i in obj){
    result = result + "<tr>";
    //返回视图显示的列
    var _fn1 = obj[i].rtfRestaurantImg+"_sm.jpg";
    var _fn2 = obj[i].rtfRestaurantImg+"_md.jpg";
    var _fn3 = obj[i].rtfRestaurantImg+"_lg.jpg";
      
    //Tools.copy("C:\\pool\\"+_fn1,"C:\\data\\culinary\\"+_fn1);
    //Tools.copy("C:\\pool\\"+_fn2,"C:\\data\\culinary\\"+_fn2);
    //Tools.copy("C:\\pool\\"+_fn3,"C:\\data\\culinary\\"+_fn3);

    var _pic = "";
    _pic = _pic + "<img style='height:30px' src='"+sails.config.globals.url.service.host+"/images/data/culinary/"+obj[i].rtfRestaurantImg+"_sm.jpg'></img>";
    _pic = _pic + "<img style='height:30px' src='"+sails.config.globals.url.service.host+"/images/data/culinary/"+obj[i].rtfRestaurantImg+"_md.jpg'></img>";
    _pic = _pic + "<img style='height:30px' src='"+sails.config.globals.url.service.host+"/images/data/culinary/"+obj[i].rtfRestaurantImg+"_lg.jpg'></img>";
    result = result + _setCol(obj[i].txtRestaurantName+"|"+obj[i].rtfRestaurantImg+"|"+_pic);
    result = result + "</tr>";
  }
  return result;
}
