...
function _setFiled(obj){
  var result = "";
  result = result + "<thead>"+_setHeader("分享名|名称|图片")+"</thead><tbody>";
  for(var i in obj){
    result = result + "<tr>";
    //返回视图显示的列
    var _pic1 = "";
    ...
    for(var j=0;j<tmp1.length;j++){
      var _fn1 = tmp1[j]+".jpg";
      //Tools.copy("C:\\pool\\"+_fn1,"C:\\data\\share\\"+_fn1);

      _pic1 =_pic1+ "<img style='height:30px' src='"+sails.config.globals.url.service.host+"/images/data/share/"+tmp1[j]+".jpg'></img>";
    }
    }
