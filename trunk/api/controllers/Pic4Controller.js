...
function _setFiled(obj){
  var result = "";
  result = result + "<thead>"+_setHeader("航区名|名称|图片|特色一|图片|特色二|图片|特色三|图片|特色四|图片")+"</thead><tbody>";
  for(var i in obj){
    result = result + "<tr>";
    //返回视图显示的列
    var _pic = "";
    ...
    for(var j=0;j<tmp1.length;j++){
      var _fn5 = tmp1[j]+".jpg";
      //Tools.copy("C:\\pool\\"+_fn5,"C:\\data\\area\\"+_fn5);
      _pic =_pic+ "<img style='height:30px' src='"+sails.config.globals.url.service.host+"/images/data/area/"+tmp1[j]+".jpg'></img>";
    }
    }

    var _pic1 = "";var _pic2 = "";var _pic3 = "";var _pic4 = "";

    if(obj[i].rtfImg_1){
    var tmp1 = (obj[i].rtfImg_1).split("@");
    var tmp2 = (obj[i].rtfImg_2).split("@");
    var tmp3 = (obj[i].rtfImg_3).split("@");
    var tmp4 = (obj[i].rtfImg_4).split("@");  
    ...
    for(var j=0;j<tmp1.length;j++){
      ...
      //Tools.copy("C:\\pool\\"+_fn1,"C:\\data\\area\\"+_fn1);
      //Tools.copy("C:\\pool\\"+_fn2,"C:\\data\\area\\"+_fn2);
      //Tools.copy("C:\\pool\\"+_fn3,"C:\\data\\area\\"+_fn3);
      //Tools.copy("C:\\pool\\"+_fn4,"C:\\data\\area\\"+_fn4);

      _pic1 =_pic1+ "<img style='height:30px' src='"+sails.config.globals.url.service.host+"/images/data/area/"+tmp1[j]+".jpg'></img>";
      _pic2 =_pic2+ "<img style='height:30px' src='"+sails.config.globals.url.service.host+"/images/data/area/"+tmp2[j]+".jpg'></img>";
      _pic3 =_pic3+ "<img style='height:30px' src='"+sails.config.globals.url.service.host+"/images/data/area/"+tmp3[j]+".jpg'></img>";
      _pic4 =_pic4+ "<img style='height:30px' src='"+sails.config.globals.url.service.host+"/images/data/area/"+tmp4[j]+".jpg'></img>";
    }
    }

    result = result + _setCol(obj[i].txtCruiseArea+"|"+obj[i].rtfImg+"|"+_pic+"|"+obj[i].rtfImg_1+"|"+_pic1+"|"+obj[i].rtfImg_2+"|"+_pic2+"|"+obj[i].rtfImg_3+"|"+_pic3+"|"+obj[i].rtfImg_4+"|"+_pic4);
    result = result + "</tr>";
  }
  return result;
}
