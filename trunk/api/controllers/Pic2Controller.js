...
function _getAll (page,limit,callback) {
  b2cApiModel.query("select * from  cruise_company limit " + (page-1)*limit + "," + limit  ,function(error,obj){
    b2cApiModel.query("select id from cruise_company" ,function(error,total){
      var utils = new Utils({
      		page:page,
      		limit:limit,
      		obj:obj,
...
function _setFiled(obj){
	var result = "";
	result = result + "<thead>"+_setHeader("公司名|特色一|图片|特色二|图片|特色三|图片")+"</thead><tbody>";
	for(var i in obj){
		result = result + "<tr>";
		//返回视图显示的列
    var _pic1 = "";var _pic2 = "";var _pic3 = "";
    if(obj[i].rtfImg_1){
    ...
    for(var j=0;j<tmp1.length;j++){
      ...
      var _fn3 = tmp3[j]+".jpg";
      /*
      Tools.copy("C:\\pool\\"+_fn1,"C:\\data\\company\\"+_fn1);
      Tools.copy("C:\\pool\\"+_fn2,"C:\\data\\company\\"+_fn2);
      Tools.copy("C:\\pool\\"+_fn3,"C:\\data\\company\\"+_fn3);
      */
      _pic1 =_pic1+ "<img style='height:30px' src='"+sails.config.globals.url.service.host+"/images/data/company/"+tmp1[j]+".jpg'></img>";
      _pic2 =_pic2+ "<img style='height:30px' src='"+sails.config.globals.url.service.host+"/images/data/company/"+tmp2[j]+".jpg'></img>";
      _pic3 =_pic3+ "<img style='height:30px' src='"+sails.config.globals.url.service.host+"/images/data/company/"+tmp3[j]+".jpg'></img>";
    
    }
    }
    
    result = result + _setCol(obj[i].txtCompanyName+"|"+obj[i].rtfImg_1+"|"+_pic1+"|"+obj[i].rtfImg_2+"|"+_pic2+"|"+obj[i].rtfImg_3+"|"+_pic3);
		result = result + "</tr>";
	}
	return result;
}
