...
function _setFiled(obj){
  var result = "";
  result = result + "<thead>"+_setHeader("设施名|名称|图片")+"</thead><tbody>";
  for(var i in obj){
    result = result + "<tr>";
    //返回视图显示的列
    var _pic1 = "";
    if(obj[i].rtfPlaceImg){

    var _fn1 = obj[i].rtfPlaceImg+"_sm.jpg";
    var _fn2 = obj[i].rtfPlaceImg+"_md.jpg";
    var _fn3 = obj[i].rtfPlaceImg+"_lg.jpg";
      
    //Tools.copy("C:\\pool\\"+_fn1,"C:\\data\\entertainment\\"+_fn1);
    //Tools.copy("C:\\pool\\"+_fn2,"C:\\data\\entertainment\\"+_fn2);
    //Tools.copy("C:\\pool\\"+_fn3,"C:\\data\\entertainment\\"+_fn3);

      _pic1 =_pic1+ "<img style='height:30px' src='"+sails.config.globals.url.service.host+"/images/data/entertainment/"+obj[i].rtfPlaceImg+"_sm.jpg'></img>";
      _pic1 =_pic1+ "<img style='height:30px' src='"+sails.config.globals.url.service.host+"/images/data/entertainment/"+obj[i].rtfPlaceImg+"_md.jpg'></img>";
      _pic1 =_pic1+ "<img style='height:30px' src='"+sails.config.globals.url.service.host+"/images/data/entertainment/"+obj[i].rtfPlaceImg+"_lg.jpg'></img>";
    }

    result = result + _setCol(obj[i].txtPlaceName+"|"+obj[i].rtfPlaceImg+"|"+_pic1);
    result = result + "</tr>";
  }
  return result;
}
