...
function _getAll (page,limit,callback) {
  b2cApiModel.query("select * from ?? limit ?,?",[_tablename,(page-1)*limit,limit],function(error,obj){
    b2cApiModel.query("select id from "+_tablename ,function(error,total){
        var utils = new Utils({
          page:page,
          limit:limit,
          obj:obj,
...
function _setFiled(obj){
  var result = "";
  result = result + "<thead>"+_setHeader("船名|名称|图片|其他|图片")+"</thead><tbody>";
  for(var i in obj){
    result = result + "<tr>";
    //返回视图显示的列
    var _pic1 = "";
    if(obj[i].rtfOtherImg){
    var tmp1 = (obj[i].rtfOtherImg).split("@");
    
    for(var j=0;j<tmp1.length;j++){
      var _fn1 = tmp1[j]+"_lg.jpg";
      var _fn2 = tmp1[j]+"_md.jpg";
      var _fn3 = tmp1[j]+"_sm.jpg";
      /*
      Tools.copy("C:\\pool\\"+_fn1,"C:\\data\\ship\\"+_fn1);
      Tools.copy("C:\\pool\\"+_fn2,"C:\\data\\ship\\"+_fn2);
      Tools.copy("C:\\pool\\"+_fn3,"C:\\data\\ship\\"+_fn3);
      */
      _pic1 =_pic1+ "<img style='height:30px' src='"+sails.config.globals.url.service.host+"/images/data/ship/"+tmp1[j]+"_lg.jpg'></img>";
      _pic1 =_pic1+ "<img style='height:30px' src='"+sails.config.globals.url.service.host+"/images/data/ship/"+tmp1[j]+"_md.jpg'></img>";
      _pic1 =_pic1+ "<img style='height:30px' src='"+sails.config.globals.url.service.host+"/images/data/ship/"+tmp1[j]+"_sm.jpg'></img>";
    }
    }

    var _pic = "";

    var _fn4 = obj[i].rtfShipImg+"_lg.jpg";
    var _fn5 = obj[i].rtfShipImg+"_md.jpg";
    var _fn6 = obj[i].rtfShipImg+"_sm.jpg";
    /*
    Tools.copy("C:\\pool\\"+_fn4,"C:\\data\\ship\\"+_fn4);
    Tools.copy("C:\\pool\\"+_fn5,"C:\\data\\ship\\"+_fn5);
    Tools.copy("C:\\pool\\"+_fn6,"C:\\data\\ship\\"+_fn6);
    */
    _pic = _pic + "<img style='height:30px' src='"+sails.config.globals.url.service.host+"/images/data/ship/"+obj[i].rtfShipImg+"_lg.jpg'></img>";
    _pic = _pic + "<img style='height:30px' src='"+sails.config.globals.url.service.host+"/images/data/ship/"+obj[i].rtfShipImg+"_md.jpg'></img>";
    _pic = _pic + "<img style='height:30px' src='"+sails.config.globals.url.service.host+"/images/data/ship/"+obj[i].rtfShipImg+"_sm.jpg'></img>";
    
    result = result + _setCol(obj[i].txtShipName+"|"+obj[i].rtfShipImg+"|"+_pic+"|"+obj[i].rtfOtherImg+"|"+_pic1);
    result = result + "</tr>";
  }
  return result;
}
