...
function _setFiled(obj){
  var result = "";
  result = result + "<thead>"+_setHeader("录入人|日期|电联/上门拜访/网上沟通|渠道来源（同事/QQ/自己资源等）|供应商/分销商|公司名字|关键人/职务|联系电话|QQ|办公地址|沟通内容|是否需要再次回访（日期）|销售/采购产品情况（如有详细航次，请写明）|是否开通平台账号|是否提供产品计划")+"</thead><tbody>";
  for(var i in obj){
    result = result + "<tr>";
    //返回视图显示的列
