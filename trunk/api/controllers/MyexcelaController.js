...
module.exports = {
  ...
  insert:function (req, res) {
     var insertSql = "insert into excelA (user_id,col0,col1,col2,col3,col4,col5,col6,col7,col8,col9,col10,col11,col12,col13,col14,col15,col16,col17,col18,col19,col20,col21,col22,col23,col24,col25,col26,col27) values("+
      req.param('user_id')+",'"+
      req.param('col0')+"','"+
      req.param('col1')+"','"+
      req.param('col2')+"','"+
  ...
  updateRecord:function (req, res) {
     var updateSql = "update excelA set col0 = '"+req.param('col0')
     +"',col1 ='"+req.param('col1')
     +"',col2 ='"+req.param('col2')
     +"',col3 ='"+req.param('col3')
     +"',col4 ='"+req.param('col4')
     ...
     +"',col14 ='"+req.param('col14')
     +"',col15 ='"+req.param('col15')
     +"',col16 ='"+req.param('col16')
     +"',col17 ='"+req.param('col17')
     +"',col18 ='"+req.param('col18')
     +"',col19 ='"+req.param('col19')
     +"',col20 ='"+req.param('col20')
     +"',col21 ='"+req.param('col21')
     +"',col22 ='"+req.param('col22')
     +"',col23 ='"+req.param('col23')
     +"',col24 ='"+req.param('col24')
     +"',col25 ='"+req.param('col25')
     +"',col26 ='"+req.param('col26')
     +"',col27 ='"+req.param('col27')
  ...
  getinfo: function (req, res) {
    ...
    var selectSql = "select * from excelA where id = " + id;
  ...
  delinfo: function (req,res) {
    var id = parseInt(req.param('id'));
    var selectSql = "delete from excelA where id = " + id;
    ApiModel.query(selectSql ,function(error,obj){
      res.send("200");
    });  
  }
...
function _setFiled(obj){
	var result = "";
	result = result + "<thead>"+_setHeader("操作|日期|状态|沟通情况备注|是否通过平台下单|团号|渠道|客户来源|客户姓名（必填）|联系电话（必填）|性别|游客信息|航次|产品类型（代服务/自营）|平台订单号|邮轮公司|人次|房间数量|舱房类型|报价|订单要求|底价|总金额|利润|供应商|付款给供应商|客户进款|是否开发票|备注")+"</thead><tbody>";
	for(var i in obj){
		result = result + "<tr>";
		//返回视图显示的列
