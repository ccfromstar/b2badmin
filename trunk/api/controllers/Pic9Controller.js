...
var LIMIT = 10;
var _tablename = "cruise_line_info";
...
function _setFiled(obj){
  var result = "";
  result = result + "<thead>"+_setHeader("航线名|名称|图片")+"</thead><tbody>";
  for(var i in obj){
    result = result + "<tr>";
    //返回视图显示的列
    var _pic1 = "";
    if(obj[i].rtfCruiselineJourneyImg){
      var _fn1 = obj[i].rtfCruiselineJourneyImg;
      //Tools.copy("C:\\pool\\"+_fn1,"C:\\data\\route\\"+_fn1);
      _pic1 =_pic1+ "<img style='height:30px' src='"+sails.config.globals.url.service.host+"/images/data/route/"+obj[i].rtfCruiselineJourneyImg+"'></img>";
      
    }

   
    result = result + _setCol(obj[i].txtCruiselineName+"|"+obj[i].rtfCruiselineJourneyImg+"|"+_pic1);
    result = result + "</tr>";
  }
  return result;
}
