...
module.exports = {
  ...
  insert:function (req, res) {
     var insertSql = "insert into customer (user_id,col0,col1,col2,col3,col4,col5,col6,col7,col8,col9) values("+
      req.param('user_id')+",'"+
      req.param('col0')+"','"+
      req.param('col1')+"','"+
      req.param('col2')+"','"+
  ...
  updateRecord:function (req, res) {
     var updateSql = "update customer set col0 = '"+req.param('col0')
     +"',col1 ='"+req.param('col1')
     +"',col2 ='"+req.param('col2')
     +"',col3 ='"+req.param('col3')
     +"',col4 ='"+req.param('col4')
...
function _setFiled(obj){
	var result = "";
	result = result + "<thead>"+_setHeader("状态|航线地区|更新日期|航次日期|航线|直客价|结算价|收客说明|供应商|操作")+"</thead><tbody>";
	for(var i in obj){
		result = result + "<tr>";
		//返回视图显示的列
   
		result = result + _setCol(obj[i].col0+"|"+obj[i].col1+"|"+obj[i].col2+"|"+obj[i].col3+"|"+obj[i].col4+"|"+obj[i].col5+"|"+obj[i].col6+"|"+obj[i].col7+"|"+obj[i].col8);
