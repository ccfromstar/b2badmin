...
var LIMIT = 10;
var _tablename = "ship_cabin_btoc";
...
function _setFiled(obj){
  var result = "";
  result = result + "<thead>"+_setHeader("名称|图片")+"</thead><tbody>";
  for(var i in obj){
    result = result + "<tr>";
    //返回视图显示的列
    var _pic1 = "";
    if(obj[i].rtfCabinImg){
    var _fn1 = obj[i].rtfCabinImg+"_sm.jpg";
    var _fn2 = obj[i].rtfCabinImg+"_md.jpg";
    var _fn3 = obj[i].rtfCabinImg+"_lg.jpg";
      
    //Tools.copy("C:\\pool\\"+_fn1,"C:\\data\\cabin\\"+_fn1);
    //Tools.copy("C:\\pool\\"+_fn2,"C:\\data\\cabin\\"+_fn2);
    //Tools.copy("C:\\pool\\"+_fn3,"C:\\data\\cabin\\"+_fn3);


      _pic1 =_pic1+ "<img style='height:30px' src='"+sails.config.globals.url.service.host+"/images/data/cabin/"+obj[i].rtfCabinImg+"_lg.jpg'></img>";
      _pic1 =_pic1+ "<img style='height:30px' src='"+sails.config.globals.url.service.host+"/images/data/cabin/"+obj[i].rtfCabinImg+"_md.jpg'></img>";
      _pic1 =_pic1+ "<img style='height:30px' src='"+sails.config.globals.url.service.host+"/images/data/cabin/"+obj[i].rtfCabinImg+"_sm.jpg'></img>";
    }
    result = result + _setCol(obj[i].rtfCabinImg+"|"+_pic1);
    result = result + "</tr>";
  }
  return result;
}
