...
function _setFiled(obj){
  var result = "";
  result = result + "<thead>"+_setHeader("港口名|名称|图片")+"</thead><tbody>";
  for(var i in obj){
    result = result + "<tr>";
    //返回视图显示的列
    var _pic1 = "";
    if(obj[i].rtfPortImg){   
    var tmp1 = (obj[i].rtfPortImg).split("@");
    var _fn1 = tmp1[0]+".jpg";
    var _fn2 = tmp1[1]+".jpg";
    var _fn3 = tmp1[2]+".jpg";
      
    //Tools.copy("C:\\pool\\"+_fn1,"C:\\data\\port\\"+_fn1);
    //Tools.copy("C:\\pool\\"+_fn2,"C:\\data\\port\\"+_fn2);
    //Tools.copy("C:\\pool\\"+_fn3,"C:\\data\\port\\"+_fn3);

      _pic1 =_pic1+ "<img style='height:30px' src='"+sails.config.globals.url.service.host+"/images/data/port/"+tmp1[0]+".jpg'></img>";
      _pic1 =_pic1+ "<img style='height:30px' src='"+sails.config.globals.url.service.host+"/images/data/port/"+tmp1[1]+".jpg'></img>";
      _pic1 =_pic1+ "<img style='height:30px' src='"+sails.config.globals.url.service.host+"/images/data/port/"+tmp1[2]+".jpg'></img>";
    }

    result = result + _setCol(obj[i].txtPortCityName+"|"+obj[i].rtfPortImg+"|"+_pic1);
    result = result + "</tr>";
  }
  return result;
}
