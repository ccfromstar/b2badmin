 ...
 */
var sslDir, passphrase;
if (process.env.NODE_ENV) {
  sslDir = __dirname + '/ssl/pro/';
  passphrase = 'Aa1234567890';
} else {
  sslDir = __dirname + '/ssl/dev/';
  passphrase = 'huiyou24';
}
...
module.exports = {
  ...
  ssl: {
    ca: require('fs').readFileSync(sslDir + 'ca.crt'),
    key: require('fs').readFileSync(sslDir + 'server.key'),
    cert: require('fs').readFileSync(sslDir + 'server.crt'),
